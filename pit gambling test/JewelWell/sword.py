...
def jewelSwordLore(tier, lives, infoList):
  global infoCommand
  # updates list
  if tier == 1:
  ...
  itemLore = ""
  if infoList[3] != -1:
    enchant1 = swordList[infoList[6]][infoList[3]][infoList[0]]
    itemLore += enchant1
  if infoList[4] != -1:
    enchant2 = swordList[infoList[7]][infoList[4]][infoList[1]]
    itemLore += "\n" + enchant2
  if infoList[5] != -1:
    enchant3 = swordList[infoList[8]][infoList[5]][infoList[2]]
    itemLore += "\n" + enchant3
  ...
  if tier < 3:
    tier += 1
    jewelSwordLore(tier, lives, infoList)
...
def get1stEnchant(infoList):
  if infoList[6] == 3:
    ...
    color = Fore.BLUE
  if infoList[3] != -1:
    return color + swordList[infoList[6]][infoList[3]][infoList[0]].split("\n")[1] + Style.RESET_ALL
  return "-"
def get2ndEnchant(infoList):
  if infoList[7] == 3:
    ...
    color = Fore.BLUE
  if infoList[4] != -1:
    return color + swordList[infoList[7]][infoList[4]][infoList[1]].split("\n")[1] + Style.RESET_ALL
  return "-"
def get3rdEnchant(infoList):
  if infoList[8] == 3:
    ...
    color = Fore.BLUE
  if infoList[5] != -1:
    return color + swordList[infoList[8]][infoList[5]][infoList[2]].split("\n")[1] + Style.RESET_ALL
...
def tier0_1(infoList):
  ...
  infoList[0] = randint(0, len(swordList[infoList[6]][infoList[3]]) - 1) # randomize enchant 1 index
  return infoList
  ...
  if addRare != 0: # -===-dont add rare-===-
    for i in range(tokensAdded):
      ...
      if infoList[enchantAddedTo - 1] == -1: # if enchant hasnt been defined yet
        infoList[enchantAddedTo - 1] = randint(0, len(swordList[infoList[enchantAddedTo + 5]][infoList[enchantAddedTo + 2]]) - 1) # define enchant
...
def fixDupeEnchants(infoList, enchantChecked):
  if enchantChecked == 1:
    while (infoList[0] == infoList[1] and infoList[6] == infoList[7]) or (infoList[0] == infoList[2] and infoList[6] == infoList[8]):
      infoList[0] = randint(0, len(swordList[infoList[6]][infoList[3]]) - 1)
    ...
    while (infoList[1] == infoList[0] and infoList[7] == infoList[6]) or (infoList[1] == infoList[2] and infoList[7] == infoList[8]):
      infoList[1] = randint(0, len(swordList[infoList[7]][infoList[4]]) - 1)
    ...
    while (infoList[2] == infoList[0] and infoList[8] == infoList[6]) or (infoList[2] == infoList[1] and infoList[8] == infoList[7]):
      infoList[2] = randint(0, len(swordList[infoList[8]][infoList[5]]) - 1)
  return infoList
