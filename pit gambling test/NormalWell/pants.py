...
def pantsLore(tier, lives, color, infoList):
  ...
  if tier < 3:
    tier += 1
    pantsLore(tier, lives, color, infoList)
...
def tier0_1(infoList):
  numberResourceTokens = 1 # limit for resource tokens
